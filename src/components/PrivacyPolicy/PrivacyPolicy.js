...
const PrivacyPolicy = () => {
  return (
    <>
      <h1>
        Privacy Policy for PARAC At RSOS, accessible from
        https://rsos-app.herokuapp.com/, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by RSOS and how we use it. If
        ...
        in RSOS. This policy is not applicable to any information collected
        offline or via channels other than this website. Our Privacy Policy was
        created with the help of the Privacy Policy Generator. Consent By using
        our website, you hereby consent to our Privacy Policy and agree to its
        ...
        ways, including to: • Provide, operate, and maintain our website •
        Improve, personalize, and expand our website • Understand and analyze
        how you use our website • Develop new products, services, features, and
        ...
        Files RSOS follows a standard procedure of using log files. These files
        ...
        for each of the advertising partners of RSOS. Third-party ad servers or
        ...
        on RSOS, which are sent directly to users' browser. They automatically
        ...
        visit. Note that RSOS has no access to or control over these cookies
        that are used by third-party advertisers. Third Party Privacy Policies
        RSOS's Privacy Policy does not apply to other advertisers or websites.
        ...
        participate in, and/or monitor and guide their online activity. RSOS
